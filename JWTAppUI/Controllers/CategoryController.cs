    ...
    public class CategoryController : Controller
    {
        ...
        public async Task<IActionResult> Create(CategoryCreateRequestModel model)
        {
            if(ModelState.IsValid)
            {
                ...
                var response = await client.PostAsync("http://localhost:5222/api/Categories", requestContent);
        ...
        public async Task<IActionResult> Update(CategoryUpdateRequestModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                var response = await client.PutAsync("http://localhost:5222/api/Categories", requestContent);
